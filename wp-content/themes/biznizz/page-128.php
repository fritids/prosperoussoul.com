...
<?php get_header(); ?>
   ...
   <div id="content" class="col-full">
		...
		<!-- /Tags -->    
	        ...
	        <?php $paged = get_query_var('paged'); query_posts("post_type=portfolio&woo_portfolio_tags=personal&posts_per_page=-1&paged=$paged"); ?>
	        <?php if (have_posts()) : while (have_posts()) : the_post(); $counter++; ?>		        					
                ...
                <div class="post block fl <?php echo $porttag; ?>">
                    ...
                    <div class="entry">
	                  ...
	                  <a href="<?php meta('ibethel_url'); ?>" class="woo-sc-button  green" ><span class="woo-"><strong>Get it now at iBethel.org</strong></span></a>
