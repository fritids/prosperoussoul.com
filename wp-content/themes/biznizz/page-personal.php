    ...
    <div id="content" class="page col-full">
		<div id="main" class="col-left">
					...
					<img src="<?php bloginfo('template_directory'); ?>/images/ico-podcast.png" width="50" height="50" alt="Ico Tools" alt="" class="home-icon" />			
	                 <div class="feature last">
		                  <h3><a href="podcasts">Recent Podcasts</a></h3>
		                   ...
		                   <?php query_posts("post_type=podcasts&cateogories=personal&posts_per_page=4"); ?>
		                   <ul>
	        <?php if (have_posts()) : while (have_posts()) : the_post(); $counter++; ?>
	        	...
	        	<?php else: ?>
						<p>Sorry, no Podcasts for Personal yet.  Check back soon!</p>
            <?php endif; ?>  
				...
				<div class="block last">
	                ...
	                <div class="feature">
	                   ...
	                   <?php query_posts("post_type=videos&cateogories=personal&posts_per_page=-3"); ?>
	                   <ul>
	        <?php if (have_posts()) : while (have_posts()) : the_post(); $counter++; ?>
	        	...
	        	<?php else: ?>
				<p>Sorry, no videos for Personal yet.  Check back soon!</p>
            <?php endif; ?>  
