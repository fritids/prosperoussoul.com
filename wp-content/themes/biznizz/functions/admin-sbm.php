...
function woo_sbm_sidebar($current_sidebar_id){
	...
	if(!empty($woo_sbm_options['sidebars'])){
		...
		$priority = array( 'page', 'page_template', 'category', 'post_tag', 'taxonomy', 'hierarchy' );
		...
		$reordered_sidebars = array_merge( (array) $reordered_sidebars, (array) $custom_taxonomies, (array) $hierarchy_sidebars );
